...
Designs, implements, and operates software applications. Trained in business, expert programmer, driven by genuine passion for Information Technology.
...
I use **TypeScript, NodeJS, Python, PostgreSQL, AWS, Terraform, GitLab** to build scriptable web services and custom AI chat services.
...
I helped to develop the full-stack web application, web services, front end, and full-text search capabilities using **Scala, Java, JavaScript, Tomcat, MySQL, PostgreSQL, Hibernate, Spring.** We delivered an innovative and extensible product supported by using-facing scripts.
