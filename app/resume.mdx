...
I use **TypeScript, NodeJS, Python, PostgreSQL, AWS, Terraform, GitLab, OpenAI ChatGPT, and [RAG](https://en.wikipedia.org/wiki/Prompt_engineering#Retrieval-augmented_generation)** to build scriptable web services and custom AI chat services.
